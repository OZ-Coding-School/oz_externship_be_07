...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ("id", models.BigAutoField(help_text="챗봇 세션 고유 ID", primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ("id", models.BigAutoField(help_text="자동 증분 ID", primary_key=True, serialize=False)),
