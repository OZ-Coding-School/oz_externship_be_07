...
from .models import ChatbotSession, chatbotMessages
...
class ChatbotSessionSerializer(serialiazers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'user', 'question', 'title', 'using_model', 'created_at', 'updated_at'
        ]
