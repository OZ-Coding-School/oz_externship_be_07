...
class ExamDeploymentService:
    ...
    def create_deployment(cls, validated_data: dict[str, Any]) -> ExamDeployment:
        ...
        if not isinstance(exam, Exam):
            raise ValueError("validated_data['exam'] must be an Exam instance.")
    ...
    @staticmethod
    def get_deployment_list_queryset() -> QuerySet[ExamDeployment]:
    ...
    @staticmethod
    def get_total_student_count(cohort: Cohort) -> int:
        """기수의 총 학생 수 계산"""
