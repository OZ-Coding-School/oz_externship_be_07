...
class CategorySerializer(serializers.ModelSerializer):
    ...
    def get_names(self, obj) -> list[str]:
        return [obj.name]
...
class QuestionListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Questions
        fields = [
            "id", "category", "author", "title", "content_preview",
            "answer_count", "view_count", "created_at", "thumbnail_img_url"
        ]

    def get_content_preview(self, obj) -> str:
        if obj.content:
            return obj.content[:50] + "..." if len(obj.content) > 50 else obj.contetn
        return ""

    def get_thumbnail_img_url(self, obj) -> str or None:
...
class QuestionListDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            "view_count", "created_at", "author", "answers"
        ]
