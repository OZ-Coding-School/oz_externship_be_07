...
class AdminQuestionListAPIView(APIView):
    ...
    @extend_schema(
        ...
        description="수강생들이 등록한 질의응답을 목록으로 조회합니다. 검색 및 정렬 기능을 적용할 수 있습니다.",
        parameters=[
            ...
            OpenApiParameter(name="search", description="검색어 (제목, 내용, 닉네임)", required=False, type=str),
            OpenApiParameter(
                name="sort",
    ...
    def get(self, request: Request) -> Response:
        ...
        result = AdminQuestionService.get_question_list(page=page, size=size, search=search, sort=sort)
