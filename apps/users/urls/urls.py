...
from apps.users.views.social_login_views import KakaoLoginView, NaverLoginView
...
urlpatterns = [
    ...
    path("social-login/kakao/callback", KakaoLoginView.as_view(), name="kakao-login"),
    path("social-login/naver/callback", NaverLoginView.as_view(), name="naver-login"),
